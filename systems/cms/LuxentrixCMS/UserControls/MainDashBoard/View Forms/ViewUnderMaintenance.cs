...
{
    public partial class ViewUnderMaintenance : Form
    {
        private Form overlay;
        private RoomStore roomStore;
        public ViewUnderMaintenance(Form overlayForm)
        {
            InitializeComponent();
            StyleRoomsGrid();
            SetupGridColumns();
            ...
            roomsDataGridView.DataSource = roomStore.FilterByStatus("Maintenance");
        }
