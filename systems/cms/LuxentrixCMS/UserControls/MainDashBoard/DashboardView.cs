...
using System.Text;
using LuxentrixContentManagementSystem.UserControls.MainDashBoard.View_Forms;
...
namespace LuxentrixContentManagementSystem.Forms
{
    public partial class DashboardView : UserControl
    {
        ...
        private void viewOccupied_Click(object sender, EventArgs e)
        {
            overlayForm overlay = new overlayForm();
            overlay.Show();
            ViewOccupiedForm occupiedForm = new ViewOccupiedForm(overlay);
        ...
        private void viewVacant_Click(object sender, EventArgs e)
        {
            overlayForm overlay = new overlayForm();
            overlay.Show();
            ViewVacant vacantForm = new ViewVacant(overlay);
            if (vacantForm.ShowDialog() == DialogResult.OK)
            {
                overlay.Close();
            }
            else
        ...
        private void viewUnderMaintenance_Click(object sender, EventArgs e)
        {
            overlayForm overlay = new overlayForm();
            overlay.Show();
            ViewUnderMaintenance underMaintenanceForm = new ViewUnderMaintenance(overlay);
            if (underMaintenanceForm.ShowDialog() == DialogResult.OK)
            {
                overlay.Close();
            }
            else
        ...
        private void viewForCleaning_Click(object sender, EventArgs e)
        {
            overlayForm overlay = new overlayForm();
            overlay.Show();
            ViewForCleaning forCleaningForm = new ViewForCleaning(overlay);
            if (forCleaningForm.ShowDialog() == DialogResult.OK)
            {
                overlay.Close();
            }
            else
        ...
        private void viewGuests_Click(object sender, EventArgs e)
        {
            overlayForm overlay = new overlayForm();
            overlay.Show();
            ViewGuests guestsForm = new ViewGuests(overlay);
            if (guestsForm.ShowDialog() == DialogResult.OK)
            {
                overlay.Close();
            }
            else
