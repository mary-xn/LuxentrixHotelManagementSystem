...
namespace LuxentrixContentManagementSystem.UserControls.Loyalty_Rewards
{
    public partial class LoyaltyRewards : UserControl
    {
        ...
        private void ResetButtons()
        {
            ...
            vouchersBtn.FillColor = Color.FromArgb(208, 189, 172);
            vouchersBtn.ForeColor = Color.Black;
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                case "VOUCHERS":
                    using (var form = new AddVoucherForm(overlay))
                    {
                        if (form.ShowDialog() == DialogResult.OK)
                        {
                            overlay.Close(); // ✅ CLOSE HERE
                ...
                case "GIFTS":
                    using (var form = new AddGiftCodeForm(overlay))
                    {
                        if (form.ShowDialog() == DialogResult.OK)
                        {
                            overlay.Close(); // ✅ CLOSE HERE
