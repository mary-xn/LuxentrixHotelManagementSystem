...
namespace LuxentrixContentManagementSystem.UserControls.Loyalty_Rewards
{
    public partial class AddVoucherForm : Form
    {
        ...
        public AddVoucherForm(Form overlayForm)
        {
            InitializeComponent();
            this.CenterToParent();
            overlay=overlayForm;
        ...
        private void dateCreatedDateTimePicker1_ValueChanged(object sender, EventArgs e)
        {

        }

        private void dateExpiryDateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
